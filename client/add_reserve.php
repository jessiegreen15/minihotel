...
<body>
	...
	<div class="container-fluid" style="max-width: 1500px; position: relative; margin-top:5%;  ">
		...
		<?php
		require_once '../admin/connect.php';
		$query = $conn->query("SELECT * FROM `room` NATURAL JOIN room_transaction NATURAL JOIN room_type WHERE `room_id` = '$_REQUEST[room_id]'");
			...
			<form method="POST" enctype="multipart/form-data">
				<div class="user-details">
					<div class="input-box">
						...
						<input type="text" placeholder="Enter your Firstname" value="<?php echo $firstname; ?>" name="firstname" required="required" />
					</div>
					<div class="input-box">
						<span class="details">Middlename</span>
						<input type="text" placeholder="Enter your Middlename" value="<?php echo $middlename; ?>" name="middlename" required="required" />
					</div>
					<div class="input-box">
						<span class="details">Lastname</span>
						<input type="text" placeholder="Enter your Lastname" value="<?php echo $lastname; ?>" name="lastname" required="required" />
					</div>
					<div class="input-box">
						<span class="details">Address</span>
						<input type="text" placeholder="Enter your Address" value="<?php echo $address; ?>" name="address" required="required" />
					</div>
					<div class="input-box">
						<span class="details">Contact No.</span>
						<input type="text" min="0" max="15" placeholder="Enter your Contact No." value="<?php echo $contactno; ?>" name="contactno" required="required" />
					</div>
					<div class="input-box">
						<span class="details">Email</span>
						<input type="email" placeholder="Enter your Email" value="<?php echo $email; ?>" name="email" required="required" />
					</div>
					<div class="input-box">
		...
		<a href="room.php" class="buton"> Back </a>
		</div>
	</div>
