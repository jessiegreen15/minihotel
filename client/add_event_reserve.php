		...
		<div class = "pan2">
			<div class = "pan1">
				...
				<div class="input-box">
                    ...
                    <input type="text" placeholder="No. of People" name = "people" type = "number" min = "10" max = "99" required = "required" />
                </div>
				<div class="input-box">
                    <span class="details">Event Name</span>
                    <input type="text" placeholder="Enter your Eventname" name = "event_name" required = "required" />
                </div>                     

				
                <div class="input-box">
                    <span class="details">Firstname</span>
                    <input type="text" placeholder="Enter your Firstname" value="<?php echo $firstname;?>" name = "firstname" disabled />
                </div>
                <div class="input-box">
                    <span class="details">Middlename</span>
                    <input type="text" placeholder="Enter your Middlename" value="<?php echo $middlename;?>" name = "middlename" disabled />
                </div>
                <div class="input-box">
                    <span class="details">Lastname</span>
                    <input type="text" placeholder="Enter your Lastname" value="<?php echo $lastname;?>" name = "lastname" disabled />
                </div>
                <div class="input-box">
                    <span class="details">Address</span>
                    <input type="text" placeholder="Enter your Address" value="<?php echo $address;?>" name = "address" disabled />
                </div>
                <div class="input-box">
                    <span class="details">Contact No.</span>
                    <input type="text" min="0" max="15" placeholder="Enter your Contact No." value="<?php echo $contactno;?>" name = "contactno" disabled />
                </div>
                <div class="input-box">
                    <span class="details">Email</span>
                    <input type="email" placeholder="Enter your Email" value="<?php echo $email;?>" name = "email" disabled />
                </div>
				<div class="input-box">
                    <span class="details">Lunch</span>
                    <input type="number" min="1" max="15" placeholder="No. of Lunches" name =  "extra_lunch" required = "required" />
                </div>
				<div class="input-box">
                    <span class="details">Snacks</span>
                    <input type="number" min="1" max="15" placeholder="No. of Snacks" name = "extra_snack" required = "required" />
                </div>
...
<script> function confirmationadd(anchor){
		var conf = confirm("Are you sure you want to add this picture to make a reservation?");
		if(conf){
