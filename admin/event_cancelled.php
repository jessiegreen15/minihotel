        ...
        <?php
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `event_transaction` NATURAL JOIN `guest` NATURAL JOIN `event_type` WHERE `status` = 'Cancelled'");
						...
						<tr>
                            ...
                            <td><center><a class = "btn btn-success" href = "view_event_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check"></i> View</a>
							 <a class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_event_approve.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-trash"></i> Discard</a></td>						</tr>
						<?php
							}
						?>
					</tbody>
