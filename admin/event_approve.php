        ...
        <?php
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `event_transaction` NATURAL JOIN `guest` NATURAL JOIN `event_type` WHERE `status` = 'Approved'");
						...
						<tr>
							...
							<td><center><a class = "btn btn-success" href = "confirm_event_reserve.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check"></i> Check In</a>
							<a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "event_cancel_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-remove"></i> Update</a></center></td>
						</tr>
						<?php
							}
						?>
...
<script type = "text/javascript">
	function confirmationDelete(anchor){
		var conf = confirm("Are you sure you want to cancel this event?");
		if(conf){
