				...
				<div class="container">
					<form method="POST" enctype="multipart/form-data" action="update_query_checkin.php?transaction_id=<?php echo $fetch['transaction_id'] ?>">
						<div class="user-details">
							...
							<div class="input-box">
								<span class="details">Balance Paid</span>
								<input type="text" placeholder="Enter No. of Days" id="" name="" value="<?php echo $fetch['amount'] + $fetch['changes'] ?>" disabled />
							</div>
							<div class="input-box">
								<span class="details">Remaining Balance</span>
								<input type="text" placeholder="Enter No. of Days" id="" name="" value="<?php echo $fetch['bill'] - $fetch['amount'] - $fetch['changes']; ?>" disabled />
							</div>
							<div class="input-box">
								<span class="details">Enter amount</span>
								<input type="number" placeholder="Enter amount" id="amount" name="amount" value="" required />
							</div>
							<input type="text" min="" placeholder="Enter No. of Days" name="room_id" value="<?php echo $fetch['room_id'] ?>" hidden />

						</div>
						<div class="button">
							<button onclick="confirmationapprove(this); return false;" name="approve" class="btn btn-success"> Pay</button>
							<a href="checkin.php"> Back</a>
						</div>
				</div>
