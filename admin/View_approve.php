	...
	<div  class = "container-fluid" style="max-width: 1500px; position: relative; margin-top:5%; ">
		<div class = "pan2">
			<div class = "pan1">
				...
				<br style = "clear:both;" />
				<div class = "container">
				<form method = "POST" enctype = "multipart/form-data" action = "yyyyyy">
				...
				<div class="input-box">
                    ...
                    <input type="text" placeholder="" name = "downpayment" id="down" value="<?php echo $fetch['bill'] * '0.3' ?>" disabled />
				</div>
				<div class="input-box">
            ...
            <div class="button">
            <a href = "reserve_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationapprove(this); return false;"  class = "btn btn-success"> Reserved</a>
			<a href="approve.php" class = "btn btn-warning"> Back</a>
            </div>
			</div> 	
