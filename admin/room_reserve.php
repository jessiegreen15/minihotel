			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table id="table" class="table table-bordered">
						...
						<tbody>
							<?php
							$query = $conn->query("SELECT * FROM `room_transaction` NATURAL JOIN `guest` NATURAL JOIN `room` NATURAL JOIN room_type WHERE `status` = 'pending' ORDER BY transaction_id");
							...
							?>
								<tr>
									...
									<td><?php echo $fetch['downpayment'] / 100 *  $fetch['price'] * $fetch['days'] ?></td>
									<td><?php echo $fetch['status'] ?></td>
									<td>
										<center><a class="btn btn-success" href="view_pending.php?transaction_id=<?php echo $fetch['transaction_id'] ?>"><i class="glyphicon glyphicon-check"></i> View </a></center>
									</td>
									</td>
								</tr>
							<?php
