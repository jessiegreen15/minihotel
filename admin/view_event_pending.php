	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				?>
				<br />
				<form method = "POST" enctype = "multipart/form-data" action = "update_query_event_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<input type = "text" value = "<?php echo $fetch['event_type_id']?>" name="event_type_id" class = "form-control" size = "40" disabled = "disabled" hidden/>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
					...
					<button name = "disapprove" class = "btn btn-warning"> Disapprove</button>
				</form>
			</div>
		</div>
	</div>
