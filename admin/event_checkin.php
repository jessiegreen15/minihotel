        ...
        <?php
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `event_transaction` NATURAL JOIN `guest` NATURAL JOIN `event_type` WHERE `status` = 'Check In'");
						...
						<tr>
							...
							<?php $lunch =$fetch['extra_lunch'] * $fetch['lunch_price']; $snack =$fetch['extra_snack'] * $fetch['snack_price']; ?>
							<td><?php echo $fetch['bill']?></td>
							<td><?php echo $fetch['amount']?></td>
							<td><?php echo $fetch['amount']- $fetch['bill']?></td>
                            <td><?php echo $fetch['status']?></td>
                            <td><center><a class = "btn btn-success" href = "event_payment.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check"></i> Pay</a>
							<td><center><a class = "btn btn-warning" href = "event_checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Check Out</a></center></td>
						</tr>
						<?php
							}
						?>
