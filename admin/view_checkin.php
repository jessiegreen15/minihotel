	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				?>
				<br />
				<form method = "POST" enctype = "multipart/form-data" action = "transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Bill </label>
						<br/>
						<input type = "number" min="10" max="100" value = "<?php echo $fetch['bill']?>" class = "form-control" size = "40" name="reservation_fee" disabled = "disabled"/>
					</div>		 							<br style = "clear:both;"/>

					</br>
                    <a name = "add_form" class = "btn btn-primary" href="event_checkin.php"><i class = "glyphicon glyphicon-save"></i> Back</a>
