	...
	<div class="container-fluid" style="max-width: 1500px; position: relative; margin-top:5%; ">
		<div class="pan2">
			<div class="pan1">
				...
				$query = $conn->query("SELECT * FROM `room` NATURAL JOIN room_type NATURAL JOIN room_transaction WHERE `room_id` = $_REQUEST[room_id] && `status` = 'Approved' OR `status` = 'approved' && service = 'Under Maintainance' &&  checkout >= '$checkin' AND checkin <= '$checkout' ");
		...
		<a href="availability.php" class="buton">Back</a>
		</div>
