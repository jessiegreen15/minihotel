		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table id="table" class="table table-bordered">
					...
					<tbody>
						<?php
						$query = $conn->query("SELECT * FROM `room_transaction` NATURAL JOIN `guest` NATURAL JOIN `room` NATURAL JOIN room_type WHERE `status` = 'Cancelled'");
						...
						?>
							<tr>
								...
								<td>
									<center><a class="btn btn-success" href="view_cancel.php?transaction_id=<?php echo $fetch['transaction_id'] ?>"><i class="glyphicon glyphicon-check"></i> View</a>
								</td>
							</tr>
						<?php
						}
