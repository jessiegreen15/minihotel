        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table id="table" class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $query = $conn->query("SELECT * FROM `room_transaction` NATURAL JOIN guest NATURAL JOIN `room` NATURAL JOIN room_type WHERE `status` = 'approved' && checkin = CURDATE() ");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="reserve_query.php?transaction_id=<?php echo $fetch['transaction_id'] ?>" onclick="confirmationCheckin(); return false;"><i class="glyphicon glyphicon-check"></i>Reserve</a></br>
                                    <a class="btn btn-warning" href="confirm_reserve.php?transaction_id=<?php echo $fetch['transaction_id'] ?>" onclick="confirmationCheckin(); return false;"><i class="glyphicon glyphicon-check"></i>Check In</a></br>
