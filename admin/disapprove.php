		...
		<?php
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `room_transaction` NATURAL JOIN `guest` NATURAL JOIN `room` NATURAL JOIN room_type WHERE `status` = 'disapprove'");
						...
						<td><?php echo $fetch['firstname']." ".$fetch['lastname']?></td>
							...
							<td><center><a class = "btn btn-success" href = "view_disapprove.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check"></i> View </a></center></td>
						</tr>
						<?php
							}
						?>
