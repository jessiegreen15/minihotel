	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				?>
				<br />
				<form method = "POST" enctype = "multipart/form-data" action = "event_payment_query.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left;">
						...
						<br />
						<input type = "number" min="0" max="100" value = "<?php echo $fetch['people']?>" class = "form-control" size = "40" name="people" disabled = "disabled"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label><?php echo "Meal Price:".$fetch['lunch_price']?></label>
						<br/>
						<input type = "number" min="0" max="100" value = "<?php echo $fetch['extra_lunch']?>" name="extra_lunch" class = "form-control" size = "40"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
					<label><?php echo "Snack Price:".$fetch['snack_price']?></label>
						<br />
						<input type = "number" min="0" max="100" value = "<?php echo $fetch['extra_snack']?>" class = "form-control" name ="extra_snack" size = "40"/>
					</div>					
					<div class = "form-inline" style = "float:left; margin-left:20px;">
                    ...
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Amount </label>
						<br/>
						<input type = "number" min="10" max="1000000" value = "" class = "form-control" size = "40" name="amount"/>
					</div>	
				<br style = "clear:both;"/>
					</br>
					<button name = "add_payment" class = "btn btn-primary"><i class = "glyphicon glyphicon-save"></i> Submit</button>
				</form>
			</div>
		</div>
	</div>
