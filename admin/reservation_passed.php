...
<?php
	...
	?>
	<br />
	<div class = "container-fluid" style="max-width: 1500px; position: relative; margin-top:5%;">	<div class = "container-fluid" style="width:auto; height:auto;">	
		...
		<?php
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `room_transaction` NATURAL JOIN `guest` NATURAL JOIN `room` NATURAL JOIN room_type WHERE `status` = 'reservation passed' ORDER BY transaction_id");
						...
						<tr>
							...
							<td><center><a class = "btn btn-success" href = "view_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check"></i> View </a></center></td>
							</td>
						</tr>
						<?php
							}
